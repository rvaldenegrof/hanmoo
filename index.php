...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>Hanmoo &mdash; Taekwondo Academy</title>
  ...
  <!-- 
	...
	<?php include ("parts/header.php") ?>
		...
		<div class="fh5co-hero">
			...
			<div class="fh5co-cover" data-stellar-background-ratio="0.5" style="background-image: url(images/1.jpg);">
				<div class="desc animate-box">
					<div class="container">
						<div class="row">
							<div class="col-md-7">
								<h2>El Taekwondo <br>es <b>Mentalidad </b></h2>
								<p><span>hanmoo <i class="icon-heart3"></i> </span></p>
				...
				<div class="row animate-box">
					<div class="col-md-10 col-md-offset-1 text-center">
						<ul class="schedule">
							...
							<li><a href="#" data-sched="monday">Lunes</a></li>
							<li><a href="#" data-sched="tuesday">Martes</a></li>
							<li><a href="#" data-sched="wednesday">Miércoles</a></li>
							<li><a href="#" data-sched="thursday">Jueves</a></li>
							<li><a href="#" data-sched="friday">Viernes</a></li>
		...
		<div class="fh5co-parallax" style="background-image: url(images/2.jpg);" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
						<div class="fh5co-intro fh5co-table-cell animate-box">
							<h1 class="text-center">S¨¦ parte de nuestra gran familia</h1>
